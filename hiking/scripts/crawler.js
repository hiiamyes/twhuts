...
(function() {
  var async, cheerio, collectionName, hutCrawlerSheiPa, hutCrawlerTaiwanForestRecreation, hutCrawlerTaroko, moment, reCrawlTime, request;
        ...
        MongoClient.connect(mongoServerUrl, function(err, db) {
          ...
          return huts.find().toArray(function(err, docs) {
            return async.each(docs, function(hut, cbAsync) {
              ...
              return console.log(moment().diff(timeStartCrawling, 'seconds'));
            });
          });
        });
